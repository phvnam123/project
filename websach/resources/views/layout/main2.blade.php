    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li><a class="dropdown-item" href="{{route('change_password')}}">change_password</a></li>
                            <!-- <li><a class="dropdown-item" href="{{route('change_password')}}">change_password</a></li> -->
                        </ul>
                    </div>
                ...
                <li class="active">
                    <a href="{{route('admin')}}"> <i class="fa fa-home" aria-hidden="true"></i><span class="nav-label">admin</span></a>
                </li>
                <li class="">
                    <a href="{{route('category')}}"><i class="fa fa-bars" aria-hidden="true"></i> <span class="nav-label">Danh mục sản phẩm</span></span></a>
                </li>
                <li>
                    <a href="{{route('product')}}"><i class="fa fa-book" aria-hidden="true"></i><span class="nav-label">Sản phẩm</span></a>
                </li>
                <li>
                    <a href="{{route('user')}}"><i class="fa fa-user" aria-hidden="true"></i> <span class="nav-label">Người dùng</span></a>
                </li>
                <li>
                    <a href="{{route('image')}}"><i class="fa fa-user" aria-hidden="true"></i> <span class="nav-label">Quản lý ảnh</span></a>
                </li>
                <li>
                    <a href="{{route('new')}}"><i class="fa fa-user" aria-hidden="true"></i> <span class="nav-label">Quản tin tức</span></a>
                </li>
                <li>
                    <a href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Đơn hàng <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="{{route('pruchases')}}">Đơn hàng nhập</a></li>
                        <li><a href="{{route('order-admin')}}">Đơn hàng bán</a></li>
                    </ul>
                </li>
                <li>
                    <a href="{{route('publishers')}}"><i class="fa fa-user" aria-hidden="true"></i> <span class="nav-label">Nhà sản xuất</span></a>
                </li>
            </ul>
